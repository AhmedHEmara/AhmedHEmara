## Hey, Ahmed Hussein here! <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="28px" height="28px">

<h1>Welcome to my corner of the Digital World.. where I break things ethically 🔐</h1>

<img src='https://github.com/MarikIshtar007/MarikIshtar007/blob/master/images/matrix.gif' alt='Awesome Matrix Code' align='right'/>

[![Linkedin Badge](https://img.shields.io/badge/-Ahmed%20Hussein-blue?style=flat-square&logo=Linkedin&logoColor=white&link=https://www.linkedin.com/in/a7med-7ussein)](https://www.linkedin.com/in/a7med-7ussein)
[![Gmail Badge](https://img.shields.io/badge/-ahmed.h.emara.tech@gmail.com-c14438?style=flat-square&logo=Gmail&logoColor=white&link=mailto:ahmed.h.emara.tech@gmail.com)](mailto:ahmed.h.emara.tech@gmail.com)
[![Portfolio](https://img.shields.io/badge/-Portfolio-0A0A0A?style=flat-square&logo=vercel&logoColor=white&link=https://profolio-wheat.vercel.app/)](https://profolio-wheat.vercel.app/)

<p align="left"> <img src="https://komarev.com/ghpvc/?username=a7med7uss" alt="a7med7uss" /> </p>

<div style="text-align: right">There are 10 types of people in the world. Those who understand binary, and those who don't.. and then there's the one trying to exploit both. 😈</div>
...
* Vulnerability Research & CTF Challenges
...
class AhmedHussein:
    ...
    current_focus = "Cybersecurity & Penetration Testing"
    
    skills = {
        "offensive": ["SQL Injection", "XSS", "MITM", "ARP Spoofing",
                      "Evil Twin", "Brute Force", "DNS Spoofing"],
        "networking": ["CCNA", "VLANs", "Subnetting", "Routing", "AAA"],
        "development": ["Flutter", "Dart", "REST APIs", "Cubit"],
    ...
    hobbies = [
        ...
        "Competitive Programming (ECPC)",
        "Watching Anime",
        "Being up all night chasing that ONE vulnerability..."
    ]
    
    def ambitions(self):
        BecomeCertifiedPentester()   # OSCP someday 🎯
